...
export class ProductService {
  ...
  products:Product[]=[
    new Product('shirts',1,"Men's Formal Shirt",200,"Fit Type: Regular, Material - 100% Cotton, Regular fit and Full sleeve shirt, Collar style - Classic collar, Cuff style - Single cuff",'/assets/images/SHIRT.jpg'),
    ...
    new Product('phone',3,"Redmi Note 10S",15000," Display: FHD+ (1080x2400) AMOLED Dot display, Camera: 64 MP Quad Rear camera, 2MP Macro and Portrait lens| 13 MP Front camera, Processor: MediaTek Helio G95 Octa-core",'/assets/images/phone.jpeg'),
    new Product('laptop',4,"HP Pavilion",73000,"Processor: AMD Ryzen 5 5600U (up to 4.2 GHz max boost clock, 16 MB L3 cache, 6 cores, 12 threads), Memory & Storage: 16 GB DDR4-3200 MHz RAM (onboard) | Storage: 512GB PCIe NVMe M.2 SSD, Display: 33.8 cm (13.3) diagonal, WUXGA (1920 x 1200), IPS, micro-edge, anti-glare",'/assets/images/laptop.jpeg'),
    ...
    new Product('powerbank',6,"Mi Power Bank",1500,"18W Fast Charging, Triple port output, Dual input port (Micro-USB/USB-C, Charging Time : 6.9 hours, Power Delivery, Advanced 12 Layer chip protection, Smart power management, 6 months domestic warranty",'/assets/images/powerBank.jpeg'),
  ]
