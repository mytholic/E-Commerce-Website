...
export class ProductService {
  ...
  products:Product[]=[
    new Product('shirts',1,"Men's Formal Shirt",200,"Fit Type: Regular, Material - 100% Cotton, Regular fit and Full sleeve shirt, Collar style - Classic collar, Cuff style - Single cuff, Pattern: Solid Men’s Formal Shirt",'/assets/images/SHIRT.jpg'),
